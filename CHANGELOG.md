...
### Fixed
- **Open Settings command**: Corrected the extension ID passed to `workbench.action.openSettings`, so the settings gear button now properly filters and opens the File Sessions extension settings panel
